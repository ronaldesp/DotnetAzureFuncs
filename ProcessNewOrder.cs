...
public class ProcessNewOrder
{
    ...
    {
        _logger.LogInformation($"C# Queue trigger function processed: {message.customerName} bought {message.quantity} of product {message.productId} at {message.purchasePrice} each.");
    }
}